...
(() => {
    ...
    function resolveTextProcessor() {
        if (typeof window !== 'undefined' && window.TextProcessor) return window.TextProcessor;
        if (typeof globalScope !== 'undefined' && globalScope.TextProcessor) return globalScope.TextProcessor;
        return null;
    }
    ...
    defineRuntimeModule('runtime.cacheContext', {
        createCacheContext(options = {}) {
            ...
            const textProcessor = resolveTextProcessor();
            if (!textProcessor) {
